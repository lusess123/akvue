        ...
        <div class="sidebar-menu-con" :style="{width: shrink?'60px':'200px', overflow: shrink ? 'visible' : 'auto'}">
            <shrinkable-menu 
                ...
                <div slot="top" class="logo-con">
                    <img v-show="!shrink"  src="../images/lw2.png" key="max-logo" />
                    <img v-show="shrink" src="../images/lw-sm.png" key="min-logo" />
                </div>
            </shrinkable-menu>
        </div>
                        ...
                        <Row type="flex" justify="end" align="middle" class="user-dropdown-innercon">
                            <Dropdown transfer trigger="click" @on-click="handleClickUserDropdown">
                                ...
                                <DropdownMenu slot="list">
                                    <DropdownItem name="ownSpace">个人中心啊</DropdownItem>
        ...
        watch: {
            '$route' (to) {
               ...
               debugger;
                ...
                this.checkTag(to.path);
                localStorage.currentPageName = to.path;
            },
            lang () {
                util.setCurrentPath(this, this.$route.path); // 在切换语言时用于刷新面包屑
            }
        },
        mounted () {
           // debugger ;
